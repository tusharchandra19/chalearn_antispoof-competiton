...
def multi_factor_scheduler(begin_epoch, epoch_size, step=[30, 60, 85, 105, 115, 120], factor=0.1):
...
def main():
    ...
    elif args.data_type == "casia-surf-cefa":
        args.num_classes = 2
        if args.depth   == 121:
            units = [6, 12, 24, 16]
        elif args.depth == 169:
    ...
    model = mx.model.FeedForward(
        ...
        num_epoch           = 250 if args.data_type == "cifar10" else 150,
        ...
        lr_scheduler        = multi_factor_scheduler(begin_epoch, epoch_size, step=[220, 260, 280], factor=0.1)
                             ...
                             multi_factor_scheduler(begin_epoch, epoch_size, step=[30, 60, 90, 100, 110, 120], factor=0.1),
        )
